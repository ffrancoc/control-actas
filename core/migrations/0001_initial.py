    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='El identificador debe ser único', max_length=50, null=None, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Masculino', 'Male'), ('Femenino', 'Female')], default='Masculino', max_length=9, null=None)),
                ('father_firstname', models.CharField(max_length=50, null=None)),
                ('father_lastname', models.CharField(max_length=50, null=None)),
                ('mother_firstname', models.CharField(max_length=50, null=None)),
                ('mother_lastname', models.CharField(max_length=50, null=None)),
                ...
                ('godfather2_fullname', models.CharField(max_length=50, null=True)),
                ('create_at', models.DateTimeField(default=django.utils.timezone.now, null=None)),
                ('modified', models.DateTimeField(null=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
